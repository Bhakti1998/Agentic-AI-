...
from AGENTIC_RAG_MONGODB.tools.attention import  get_query_results_attn
...
class attentiontool:
    ...
    def atten_tool(self,state: AgentState):
        ...
        try:
            ...
            if len(tool_messages) == 0:
                ...
                return {
                        'messages':[HumanMessage(content=[org_query]+[ai_messages])],
                        'topic':query,
                        'chunks': ['No Tools available'],
                ...
                if len(positive_pairs)==0:
                    ...
                    chunks['attn_paper'].append(details)
...
#                 },
#             'task_state' : 'START'}
#         logger = attentiontool(api_key).atten_tool(val)
#         print(logger)
#     except Exception as e:
#         print(e)
